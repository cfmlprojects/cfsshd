...
/**
 * wrapper for filesystem, allows different root, etc..
 *
 * @author denny valliant
 */
public class WrappedFileSystemFactory implements FileSystemFactory {

    private final Logger LOG = LoggerFactory.getLogger(WrappedFileSystemFactory.class);
...
//                            + homeDirStr);
        ...
        FileSystemView fsView = new WrappedFileSystemView(userName, caseInsensitive);
        return fsView;
    }
}
